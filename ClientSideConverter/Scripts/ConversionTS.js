document.addEventListener('DOMContentLoaded', function () {
    ...
    function convertUnits(conversionFactors) {
        var inputValue = parseFloat(document.getElementById('UnitToConvert').value);
        if (isNaN(inputValue)) {
    ...
    document.getElementById('UnitToConvert').addEventListener('keypress', function (e) {
        if (e.key === 'Enter') {
            document.getElementById('ConvertButton').click();
        }
    });
    document.getElementById('ConvertButton').addEventListener('click', function () {
        var conversionType = document.getElementById('ConvertButton').getAttribute('data-conversion');
        if (conversionType) {
...
//# sourceMappingURL=ConversionTS.js.map